...
<a name="arguments-for"></a>

## 4. [Arguments for and Models of Propertization](#arguments-for)
...
<a name="arguments-against"></a>

## 5. [Arguments against and Alternatives to Propertization](#arguments-against)
